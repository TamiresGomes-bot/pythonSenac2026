...
print('1 - Polegada\n2 - Pé\n3 - Jarda') # ->\ barra é um quebra linha
menu = input ('Opção: ') #se tiver o tipo int eu declaro o valor sem aspas simples se for string (texto) coloco entre aspas simples
if(menu == '1' ):
    unidade = 'Polegada'
